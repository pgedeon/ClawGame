...
**Next:** CEO review/merge of branch; P0 formally closable per ruling #1 once merged. Lane A anthropic adapter untouched (`apps/api/src/services/ai/` not modified).
**Blockers:** none.
