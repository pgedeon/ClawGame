...
const GENRE_CONTROLS: Record<string, {
  title: string;
  description: string;
  ...
  platformer: {
    title: 'Platformer',
    description: 'Jump between platforms, collect items, and reach the goal!',
    items: [
  ...
  rpg: {
    title: 'RPG',
    description: 'Explore, talk to NPCs, complete quests, and defeat enemies!',
    items: [
  ...
  action: {
    title: 'Action',
    description: 'Defeat enemies, dodge attacks, and survive!',
    items: [
      { icon: '🎯', text: 'WASD/Arrows to move' },
  ...
  puzzle: {
    title: 'Puzzle',
    description: 'Solve puzzles and find the solution!',
    items: [
      { icon: '🎯', text: 'WASD/Arrows to move' },
      { icon: '🧩', text: 'Interact with objects' },
      { icon: '🧠', text: 'Find the solution' },
    ],
  },
  default: {
    title: 'Game',
    description: 'Use the controls below to play!',
    items: [
      { icon: '🎯', text: 'WASD/Arrows to move' },
      { icon: '⚡', text: 'Explore and interact' },
    ],
  },
};
